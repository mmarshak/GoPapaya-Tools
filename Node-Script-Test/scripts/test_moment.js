...
let mLocale = moment_timezone(newDate);


log("mLocale = %s", mLocale);
log("mLocale.format() = %s", mLocale.format());


log("mLocale.tz(America-Los_Angeles) = %s", mLocale.tz("America/Los_Angeles"));
